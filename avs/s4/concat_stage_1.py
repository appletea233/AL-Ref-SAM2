...
def concat(jpg_dir, category, video_name, concat_jpg_dir):
    T = 5
    ...
    save_dir = os.path.join(concat_jpg_dir, category, video_name)
...
if __name__ == "__main__":
    ...
    for index in range(len(df_test)):
        ...
        concat(cfg.DATA.JPG_IMG_DIR, category, video_name, concat_jpg_dir)
