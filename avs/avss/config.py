...
cfg.LANGUAGEBIND.AUDIO_SEGMENT_FILE = "../audio_segment/avss_audio_segment.json"
...
cfg.LANGUAGEBIND.LABEL_REPLACEMENT = os.path.join(cfg.OUTPUT_DIR, "label_replacement.json")
...
# data
cfg.DATA = edict()
cfg.DATA.BASE_DIR = "YOUR AVSBench AVSBench_semantic DIR" # TODO
cfg.DATA.ANNO_CSV = os.path.join(cfg.DATA.BASE_DIR, "metadata.csv")
cfg.DATA.LABEL2IDX = os.path.join(cfg.DATA.BASE_DIR, "label2idx.json")
