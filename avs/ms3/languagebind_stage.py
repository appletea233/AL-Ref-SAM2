...
if __name__ == '__main__':
    ...
    for video_name in tqdm.tqdm(name_label_keyframe):
        ...
        # split audio files
        audio_path = os.path.join(cfg.DATA.AUDIO_WAV_DIR, f"{video_name}.wav")
        audio_segment_path = os.path.join(cfg.LANGUAGEBIND.AUDIO_SEGMENT_WAV_DIR, video_name)
