...
if __name__ == '__main__':
    ...
    for index in range(len(df_test)):
        ...
        for label, keyframe in label_keyframe.items():
            ...
            IMAGE_PATH = os.path.join(cfg.DATA.PNG_IMG_DIR, video_name, f"{video_name}.mp4_{keyframe}.png")
            TEXT_PROMPT = label
            ...
            annotated_frame_path = os.path.join(vis_output_dir, f"{video_name}_{label}_{keyframe}_dino.jpg")
